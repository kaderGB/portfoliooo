    ...
    <div className='techstack' id="techstack">
      ...
      <div className='tech_list'>
        ...
        <img src={IMG3} alt="" className='tech_icon'/>
          <img src={IMG1} alt="" className='tech_icon'/>
          <img src={IMG4} alt="" className='tech_icon'/>
        <img src={IMG5} alt="" className='tech_icon'/>
            <img src={IMG6} alt="" className='tech_icon'/>
            <img src={IMG7} alt="" className='tech_icon'/>
       ...
       <div className='tech_list'>
         <img src={IMG14} alt="" className='tech_icon'/>
        <img src={IMG15} alt="" className='tech_icon'/>
          <img src={IMG16} alt="" className='tech_icon'/>
          <img src={IMG17} alt="" className='tech_icon'/>
        <img src={IMG18} alt="" className='tech_icon'/>
            <img src={IMG19} alt="" className='tech_icon'/>
            <img src={IMG20} alt="" className='tech_icon'/>
             <img src={IMG21} alt="" className='tech_icon'/>
              <img src={IMG22} alt="" className='tech_icon'/>
                   
      </div>

      <div className='tech_list'>
         <img src={IMG23} alt="" className='tech_icon'/>
        <img src={IMG24} alt="" className='tech_icon'/>
          <img src={IMG25} alt="" className='tech_icon'/>
          <img src={IMG26} alt="" className='tech_icon'/>
        <img src={IMG27} alt="" className='tech_icon'/>
            <img src={IMG28} alt="" className='tech_icon'/>
            <img src={IMG29} alt="" className='tech_icon'/>
             <img src={IMG30} alt="" className='tech_icon'/>
              <img src={IMG31} alt="" className='tech_icon'/>
                   
      </div>


      <div className='tech_list'>
         <img src={IMG32} alt="" className='tech_icon'/>
        <img src={IMG33} alt="" className='tech_icon'/>
          <img src={IMG34} alt="" className='tech_icon'/>
          <img src={IMG35} alt="" className='tech_icon'/>
           <img src={IMG36} alt="" className='tech_icon'/>
